...
MEMEND  fdb     $B800       ;$CC2B   ;MEMORY END
...
INCH    jmp     CONIN       ;INCHNE           ;INPUT ROUTINE
INCH2   jmp     INCHNE_           ;TERMINAL INPUT
OUTCH   jmp     CONOUT      ;VOUTCH           ;OUTPUT CHARACTER
...
DSTAT   jmp     CONSTAT ;STAT           ;TERMINAL INPUT STATUS
DSPR2   jmp     RTS
DSPR3   jmp     RTS
