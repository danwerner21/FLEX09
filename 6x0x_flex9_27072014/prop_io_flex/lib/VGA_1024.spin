...
PUB cls1(c,screencolor,pcport,ascii,CR) | i,x,y
  ...
  statprint(38,0, string("                                 propIO  V 0.91                                 "))
  inverse := 0
'  statprint(37,0, string("Baud Rate:  9600  Color    PC Port:  OFF  Force 7 bit:  NO  Cursor   CR W/LF  NO"))
'  statprint(38,0, string("      F1           F2           F3               F4          F5          F6     "))
